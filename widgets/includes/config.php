...
//to make a dynamic navigation - creating variable for each page
$nav1['index.php'] = "HOME";
$nav1['customer.php'] = "CUSTOMER";
$nav1['contact.php'] = "CONTACT";
$nav1['daily.php'] = "DAILY";
$nav1['parasite.php'] = "PARASITES";
...
//This links the navigation pages and highlights the current page
